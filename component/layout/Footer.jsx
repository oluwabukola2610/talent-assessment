    ...
    <footer className="pt-10">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600">
        <div className="justify-between lg:flex">
          ...
          {/* links */}
          <div className=" mt-16  grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-20 grid  text-[#475467] text-lg font-semibold">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-row items-center gap-3 mt-3 sm:flex-col">
